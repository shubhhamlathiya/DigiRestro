...
$(function () {
    ...
    $(".settingbtn").on("click", function () {
        $(".setting").toggleClass("showSettingPanel");
    }),
        $(".page-wrapper").on("click", function () {
            $(".setting").removeClass("showSettingPanel");
        });

    $(".addbtn").on("click", function () {
        $(".add").toggleClass("showSettingPanel");
    }),
        $(".page-wrapper").on("click", function () {
            $(".add").removeClass("showSettingPanel");
        });

    $(".updatebtn").on("click", function () {
        $(".update").toggleClass("showSettingPanel");
    }),
        $(".page-wrapper").on("click", function () {
            $(".update").removeClass("showSettingPanel");
        });

    $(".subbtn").on("click", function () {
        $(".sub").toggleClass("showSettingPanel");
    }),
        $(".page-wrapper").on("click", function () {
            $(".sub").removeClass("showSettingPanel");
        });
